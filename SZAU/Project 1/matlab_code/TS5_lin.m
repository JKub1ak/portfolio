function root = TS5_lin(V1_last,V2_last)
	global data TS_data;
	...
	p(3) = trimf(V2_last,[TS_data.points(2), TS_data.points(3), TS_data.points(4)]);
	p(4) = trimf(V2_last,[TS_data.points(3), TS_data.points(4), TS_data.points(5)]);
	p(5) = trapmf(V2_last,[TS_data.points(4), TS_data.points(5), inf, inf]);
